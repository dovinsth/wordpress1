...
function quiz_master_generate_admin_quiz_two()
{
	...
	$quiz_master_temp_data = get_option('quiz_master_questions_1');
	...
	<td><select name="quiz_master_question_amount_1"><?php  $opt_ply = get_option('quiz_master_question_amount_1'); ?>
	...
	<?php
	$quiz_master_question_amount = get_option('quiz_master_question_amount_1');
	for ($i=0; $i<=$quiz_master_question_amount -1; $i++)
	{
		for ($l=1; $l<=8; $l++)
		{
			$name_id[$l] = "quiz_master_questions_1[" . $i . "][" . $l . "][1]";
		...
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][0]' value='" . $quiz_master_data[$i][0] . "' /></td>
		</tr>";
		
		echo "<tr valign='top'>
		<th scope='row'>First Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][1][0]' value='" . $quiz_master_data[$i][1][0] . "' /></td>		
		<td>";
		?>
		<input name="<?php echo $name_id[1]; ?>" id=<?php echo $name_id[1]; ?> type='checkbox' value='1' <?php echo $is_checked[1]; ?> /></td>
		<?php
		echo "<td><input type='text' name='quiz_master_questions_1[" . $i . "][1][2]' value='" . $quiz_master_data[$i][1][2] . "' /></td>
		</tr>";
		
		echo "<tr valign='top'>
		<th scope='row'>Second Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][2][0]' value='" . $quiz_master_data[$i][2][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[2]; ?>" id=<?php echo $name_id[2]; ?> type='checkbox' value='1' <?php echo $is_checked[2]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][2][2]' value='" . $quiz_master_data[$i][2][2] . "' /></td>
		</tr>";
		
		echo "<tr valign='top'>
		<th scope='row'>Third Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][3][0]' value='" . $quiz_master_data[$i][3][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[3]; ?>" id=<?php echo $name_id[3]; ?> type='checkbox' value='1' <?php echo $is_checked[3]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][3][2]' value='" . $quiz_master_data[$i][3][2] . "' /></td>
		</tr>";
		
		echo "<tr valign='top'>
		<th scope='row'>Fourth Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][4][0]' value='" . $quiz_master_data[$i][4][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[4]; ?>" id=<?php echo $name_id[4]; ?> type='checkbox' value='1' <?php echo $is_checked[4]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][4][2]' value='" . $quiz_master_data[$i][4][2] . "' /></td>
		</tr>";

		echo "<tr valign='top'>
		<th scope='row'>Fifth Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][5][0]' value='" . $quiz_master_data[$i][5][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[5]; ?>" id=<?php echo $name_id[5]; ?> type='checkbox' value='1' <?php echo $is_checked[5]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][5][2]' value='" . $quiz_master_data[$i][5][2] . "' /></td>
		</tr>";

		echo "<tr valign='top'>
		<th scope='row'>Sixth Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][6][0]' value='" . $quiz_master_data[$i][6][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[6]; ?>" id=<?php echo $name_id[6]; ?> type='checkbox' value='1' <?php echo $is_checked[6]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][6][2]' value='" . $quiz_master_data[$i][6][2] . "' /></td>
		</tr>";

		echo "<tr valign='top'>
		<th scope='row'>Seventh Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][7][0]' value='" . $quiz_master_data[$i][7][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[7]; ?>" id=<?php echo $name_id[7]; ?> type='checkbox' value='1' <?php echo $is_checked[7]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][7][2]' value='" . $quiz_master_data[$i][7][2] . "' /></td>
		</tr>";	
		
		echo "<tr valign='top'>
		<th scope='row'>Eigth Answer</th>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][8][0]' value='" . $quiz_master_data[$i][8][0] . "' /></td>
		<td>";
		?>
		<input name="<?php echo $name_id[8]; ?>" id=<?php echo $name_id[8]; ?> type='checkbox' value='1' <?php echo $is_checked[8]; ?> /></td>
		<?php
		echo "</td>
		<td><input type='text' name='quiz_master_questions_1[" . $i . "][8][2]' value='" . $quiz_master_data[$i][8][2] . "' /></td>
		</tr>";	
	...
	<input type="hidden" name="page_options" value="quiz_master_questions_1,quiz_master_question_amount_1" />
