 ...
 */
function testtheme_register_custom_background() {
	$args = array(
		'default-color' => 'ffffff',
		'default-image' => '',
	);

	$args = apply_filters( 'testtheme_custom_background_args', $args );
...
add_action( 'after_setup_theme', 'testtheme_register_custom_background' );
